...
@section('content')
    <div class="flex justify-between items-center mb-6 pt-16">
        <h1 class="text-3xl text-white font-semibold">Transaction List</h1>
    </div>
            ...
            <tbody>
                ...
                @foreach ($transactions as $date => $transaction)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <td rowspan="{{ count($transaction) }}" class="px-6 py-4">{{ $date }}</td>
                ...
                <td class="px-6 py-4">
                    <span
                        ...
                        {{ $per_transaction->status }}
                    </span>

                </td>
                @if ($index === 0)
                    <td class="flex gap-2 px-6 py-4" rowspan="{{ count($transaction) }}">
